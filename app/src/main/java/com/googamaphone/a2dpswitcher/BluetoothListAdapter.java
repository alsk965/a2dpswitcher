...
public class BluetoothListAdapter extends BaseAdapter implements ListAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            ...
            final int colorControl = labelView.getTextColors().getDefaultColor();
            settings.setColorFilter(colorControl, Mode.SRC_IN);
        ...
        final boolean labelsEnabled = !mShowAllDevices || isDeviceVisible(device);
        labelView.setEnabled(labelsEnabled);
        statusView.setEnabled(labelsEnabled);
